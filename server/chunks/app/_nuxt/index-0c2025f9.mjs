import { _ as _export_sfc, h as useBaseStore, s as storeToRefs, b as __nuxt_component_1, i as _sfc_main$j, k as __nuxt_component_2$1, a as __nuxt_component_0$3, w as __nuxt_component_4, x as __nuxt_component_5 } from '../server.mjs';
import { _ as __nuxt_component_0 } from './Editor-6f6ea1df.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-2f1a05e5><div class="flex flex-wrap items-center justify-between sticky" data-v-2f1a05e5><div class="flex" data-v-2f1a05e5><div class="lg:hidden mr-2 flex items-center cursor-pointer" data-v-2f1a05e5>`);
      _push(ssrRenderComponent(_component_UnoIcon, { class: "i-ic-round-arrow-back-ios text-sm lg:text-base" }, null, _parent));
      _push(`</div><h1 class="text-lg lg:text-xl font-bold" data-v-2f1a05e5>\u5E33\u865F\u7BA1\u7406</h1></div><div class="group rounded-full cursor-pointer bg-green-500 text-white text-sm font-bold px-4 h-8 leading-8 flex items-center" data-v-2f1a05e5><span class="pr-1 duration-150" data-v-2f1a05e5> \u4FDD\u5B58 </span>`);
      _push(ssrRenderComponent(_component_UnoIcon, { class: "i-ic-baseline-save-alt" }, null, _parent));
      _push(`</div></div><div class="py-3" data-v-2f1a05e5>`);
      _push(ssrRenderComponent(_component_UIForm, {
        onSubmit: ($event) => unref(user).update(unref(form))
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center" data-v-2f1a05e5${_scopeId}></div><div class="flex items-center space-x-4" data-v-2f1a05e5${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_component_UIFormText, {
              ...
              label: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(`<div class="${ssrRenderClass(unref(emailColor))}" data-v-2f1a05e5${_scopeId2}>`);
                  if (((_a = unref(info)) == null ? void 0 : _a.emailStatus) === 20) {
                    _push3(`<div class="flex items-center font-bold ml-3 space-x-1" data-v-2f1a05e5${_scopeId2}>`);
            ...
            _push2(ssrRenderComponent(_component_UIFormText, {
              ...
              label: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a, _b, _c, _d;
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle(((_a = unref(info)) == null ? void 0 : _a.identityStatus) === 23 ? null : { display: "none" })}" class="flex items-center font-bold ml-3 text-green-400 space-x-1" data-v-2f1a05e5${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_UnoIcon, { class: "i-ion-checkmark-circled" }, null, _parent3, _scopeId2));
                  _push3(` \u5DF2\u9A57\u8B49 </div>`);
                  _push3(ssrRenderComponent(_component_NuxtLink, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        if (((_a2 = unref(info)) == null ? void 0 : _a2.identityStatus) === 24) {
                          ...
                          _push4(` \u672A\u9A57\u8B49 <span class="text-blue-400 pl-1" data-v-2f1a05e5${_scopeId3}>\u53BB\u9A57\u8B49</span><!--]-->`);
                          ...
                          _push4(` \u5BE9\u6838\u4E2D <span class="text-blue-400 pl-1" data-v-2f1a05e5${_scopeId3}>\u4FEE\u6539</span><!--]-->`);
                          ...
                          _push4(` \u672A\u901A\u904E <span data-v-2f1a05e5${_scopeId3}>: ${ssrInterpolate((_d2 = unref(info)) == null ? void 0 : _d2.rejectReason)}</span><span class="text-blue-400 pl-1" data-v-2f1a05e5${_scopeId3}>\u91CD\u65B0\u9A57\u8B49</span><!--]-->`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2f1a05e5"]]);

export { index as default };
//# sourceMappingURL=index-0c2025f9.mjs.map
