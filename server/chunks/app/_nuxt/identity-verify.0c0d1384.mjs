...
import { _ as _sfc_main$3 } from './Text.045e0b5f.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="${ssrRenderClass([{ model: !imageData.value }, "relative border border-gray-300 border-opacity-40 rounded dark:bg-white/[0.05] bg-gray-100"])}" data-v-d10ebd38>`);
      if (imageData.value.length > 0) {
        _push(`<div data-v-d10ebd38><img class="preview w-full h-full"${ssrRenderAttr("src", imageData.value)} data-v-d10ebd38></div>`);
      } else {
...
//# sourceMappingURL=identity-verify.0c0d1384.mjs.map
