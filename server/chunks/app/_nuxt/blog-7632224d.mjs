import { d as useHttpPost, C as useAppConfig, B as _sfc_main$r, b as __nuxt_component_1 } from '../server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useAppConfig();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "border-t lg:border-gray-900/10 dark:border-gray-50/[0.2]" }, _attrs))}><section class="max-w-[96em] mx-auto px-4 lg:px-8 flex-1 flex w-full space-x-20"><div class="text-xs w-full py-4 text-center md:text-left"><div class="text-gray-600 dark:text-gray-400"> Copyright \xA9 2022. All rights reserved. <span class="md:float-right"> Design By <a href="#">Bonding</a></span></div></div></section></footer>`);
    };
  }
});
...
//# sourceMappingURL=blog-7632224d.mjs.map
