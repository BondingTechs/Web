import { _ as __nuxt_component_0, a as __nuxt_component_4$1, b as __nuxt_component_5 } from './index.67844f76.mjs';
import { _ as _sfc_main$3 } from './Title.97d3dce4.mjs';
import { g as useHttpPost, d as __nuxt_component_0$1, b as __nuxt_component_1, _ as _export_sfc } from '../server.mjs';
...
import { _ as __nuxt_component_6 } from './Row.7fddd852.mjs';
import { _ as _sfc_main$4 } from './Filter.b0cafd25.mjs';
import 'ohmyfetch';
import 'hookable';
import 'unctx';
import 'destr';
...
import 'pathe';
import 'axios';
import './RowLoading.9b1a0276.mjs';
          ...
          ssrRenderList($props.list, (slide2) => {
            _push2(ssrRenderComponent(_component_SwiperSlide, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<div class="absolute top-0 left-0 w-full h-full" data-v-8971723f${_scopeId2}><img${ssrRenderAttr("src", slide2.thumbnail)} class="object-cover w-full h-full" data-v-8971723f${_scopeId2}></div><div class="row flex flex-wrap content-end absolute bottom-0 left-0 w-full px-4 h-1/3 pb-7 md:pb-5 lg:pb-10 lg:px-6" data-v-8971723f${_scopeId2}><div class="flex items-center w-full pb-1 md:pb-3 text-xs space-x-1 md:space-x-3 text-white" data-v-8971723f${_scopeId2}><div class="w-fit h-6 leading-6 px-2 rounded bg-green-500" data-v-8971723f${_scopeId2}>${ssrInterpolate($setup.ArticleType[slide2.type])}</div><!--[-->`);
                  ssrRenderList((_a = slide2.categories) == null ? void 0 : _a.split(","), (item, index2) => {
                    _push3(`<div class="w-fit h-6 leading-6 px-2 rounded bg-blue-500" data-v-8971723f${_scopeId2}>${ssrInterpolate(item)}</div>`);
                  });
                  _push3(`<!--]--></div><h3 class="title text-sm md:text-xl font-bold tracking-widest text-white" data-v-8971723f${_scopeId2}>${ssrInterpolate(slide2.title)}</h3></div>`);
                  _push3(ssrRenderComponent(_component_nuxt_link, {
                    to: `/news/article/${slide2.slug}`,
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-8971723f"]]);
const _sfc_main$1 = {
  __name: "Hot",
                  ...
                  _push3(ssrRenderComponent(_component_LayoutSection, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_ArticleLoopRow, {
                          tag: "h3",
                          list: (_b = (_a = unref(newsPage)) == null ? void 0 : _a.list) != null ? _b : [],
                          infinite: true,
                          loading: loading.value,
                          onLoad: loadNews
                        }, null, _parent4, _scopeId3));
                        if (((_d = (_c = unref(newsPage)) == null ? void 0 : _c.pagination) == null ? void 0 : _d.total) > ((_f = (_e = unref(newsPage)) == null ? void 0 : _e.pagination) == null ? void 0 : _f.size) * ((_h = (_g = unref(newsPage)) == null ? void 0 : _g.pagination) == null ? void 0 : _h.page)) {
                        ...
                        return [
                          ...
                          createVNode(_component_ArticleLoopRow, {
                            tag: "h3",
                            list: (_j = (_i = unref(newsPage)) == null ? void 0 : _i.list) != null ? _j : [],
                            infinite: true,
                            loading: loading.value,
                            onLoad: loadNews
                          }, null, 8, ["list", "loading"]),
                          ((_l = (_k = unref(newsPage)) == null ? void 0 : _k.pagination) == null ? void 0 : _l.total) > ((_n = (_m = unref(newsPage)) == null ? void 0 : _m.pagination) == null ? void 0 : _n.size) * ((_p = (_o = unref(newsPage)) == null ? void 0 : _o.pagination) == null ? void 0 : _p.page) ? (openBlock(), createBlock("div", {
                            key: 0,
                    ...
                    createVNode(_component_LayoutSection, null, {
                      default: withCtx(() => {
                        ...
                        return [
                          ...
                          ((_d = (_c = unref(newsPage)) == null ? void 0 : _c.pagination) == null ? void 0 : _d.total) > ((_f = (_e = unref(newsPage)) == null ? void 0 : _e.pagination) == null ? void 0 : _f.size) * ((_h = (_g = unref(newsPage)) == null ? void 0 : _g.pagination) == null ? void 0 : _h.page) ? (openBlock(), createBlock("div", {
                            key: 0,
                            class: ["block py-4 mt-3 text-xs font-bold text-center text-gray-500 duration-300 border-t border-b border-gray-300 dark:text-gray-400 dark:border-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer", { hidden: loading.value }],
                            onClick: ($event) => loadNews()
                          }, [
...
//# sourceMappingURL=index.008d529e.mjs.map
