...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "lg:px-8 mb-4 last-mb-0" }, _attrs))}>`);
  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(`</div>`);
}
...
export { __nuxt_component_0 as _, __nuxt_component_4 as a, __nuxt_component_5 as b };
//# sourceMappingURL=index-99353a97.mjs.map
