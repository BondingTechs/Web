...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "cma mb-0 md:flex flex-wrap lg:px-8 lg:py-5 my" }, _attrs))} data-v-99c5bb5a><div class="lt-lg:hidden w-48 mr-10" data-v-99c5bb5a><div class="items rounded border border-gray-200 dark:border-gray-300 dark:border-opacity-30" data-v-99c5bb5a><!--[-->`);
      ssrRenderList(unref(items), (item, index) => {
        ...
        if (item.path) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`<span data-v-99c5bb5a${_scopeId}>${ssrInterpolate(item.label)}</span>`);
              } else {
                return [
          ...
          _push(`<div class="flex items-center cursor-pointer text-sm font-bold py-3 px-3 hover:bg-gray-200 dark:bg-opacity-10 border-b dark:border-opacity-30 border-gray-200 last-border-0 duration-200" data-v-99c5bb5a>`);
          _push(ssrRenderComponent(_component_UnoIcon, {
            class: ["mr-3", item.icon]
          }, null, _parent));
          _push(`<span data-v-99c5bb5a>${ssrInterpolate(item.label)}</span></div>`);
        }
        _push(`<!--]-->`);
      });
      _push(`<!--]--></div></div><div class="flex-1 relative" data-v-99c5bb5a>`);
...
const my = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-99c5bb5a"]]);

export { my as default };
//# sourceMappingURL=my-af7d4fb0.mjs.map
