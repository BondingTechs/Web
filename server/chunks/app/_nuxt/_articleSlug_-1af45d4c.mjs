import { _ as __nuxt_component_0, a as __nuxt_component_4, b as __nuxt_component_5 } from './index-e9d4f27b.mjs';
import { _ as __nuxt_component_1 } from './Header-d1fd6db2.mjs';
import { _ as _sfc_main$a } from './Title-1189b41a.mjs';
import { h as useBaseStore, s as storeToRefs, n as useRoute, d as useHttpPost, e as useState, z as htmlTag, A as _imports_0$1, g as useHttpFetchPost, b as __nuxt_component_1$1, r as __nuxt_component_0$2, _ as _export_sfc, a as __nuxt_component_0$3 } from '../server.mjs';
import { useSSRContext, defineComponent, withAsyncContext, watch, ref, computed, withCtx, unref, createVNode, withDirectives, vShow, toDisplayString, openBlock, createBlock, createCommentVNode, mergeProps, isRef } from 'vue';
...
import { _ as __nuxt_component_0$1 } from './Editor-06e13f73.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import 'vue-router';
...
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-70eb8a86"]]);
  ...
  async setup(__props) {
    ...
    const { data: moreNews } = ([__temp, __restore] = withAsyncContext(() => {
      ...
      return useHttpPost(
        ...
        "/news/list",
        { body: { articleId: (_a = article.value) == null ? void 0 : _a.id, size: 3 } }
      );
    }), __temp = await __temp, __restore(), __temp);
    const $message = useState("message");
    ...
    const likeArticle = async () => {
      ...
      if (isLogin.value) {
        const {
          ...
          body: { id: (_a = article.value) == null ? void 0 : _a.id }
        });
        if (error)
    ...
    const { data: comments } = ([__temp, __restore] = withAsyncContext(() => {
      ...
      return useHttpPost(
        ...
        "/comment/page",
        { body: { articleId: (_a = article.value) == null ? void 0 : _a.id, page: 1, size: 10 } }
      );
    }), __temp = await __temp, __restore(), __temp);
    const createComment = async (content) => {
      var _a;
      const { error, message, data } = await useHttpFetchPost("/comment/create", {
        body: { content, articleId: (_a = article.value) == null ? void 0 : _a.id }
      });
      if (error)
        return $message.value = message;
    ...
    const commentIsEnd = computed(() => {
      var _a;
      const { page = 1, size = 1, total = 1 } = (_a = comments.value) == null ? void 0 : _a.pagination;
      return page * size >= total;
    });
    const commentLoading = ref(false);
    const moreComments = async () => {
      var _a, _b, _c, _d, _e;
      if (commentIsEnd.value || !((_b = (_a = comments.value) == null ? void 0 : _a.list) == null ? void 0 : _b.length))
        return;
    ...
    watch(offset, (val) => {
      ...
      const offsetTop = ((_a = comment.value) == null ? void 0 : _a.offsetTop) || 0;
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UITitle, {
                    title: (_a = unref(article)) == null ? void 0 : _a.title,
                    size: "sm",
                    color: "gray-500",
                    "dark-color": "gray-400",
                    previous: true,
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_UnoIcon, {
                          style: !((_a2 = unref(article)) == null ? void 0 : _a2.isCollection) ? null : { display: "none" },
                          ...
                          createVNode("div", { class: "fb space-x-4 text-gray-500 dark:text-gray-400 lg:space-x-4" }, [
                            createVNode("div", { class: "ml-auto fic space-x-2 md:space-x-5" }, [
                              createVNode("div", {
                                ...
                                withDirectives(createVNode(_component_UnoIcon, { class: "i-ion-heart-outline w-6 lt-md:text-sm" }, null, 512), [
                                  [vShow, !((_a2 = unref(article)) == null ? void 0 : _a2.isCollection)]
                                ]),
                                withDirectives(createVNode(_component_UnoIcon, { class: "i-ion-heart-sharp text-red-600 w-6 lt-md:text-sm" }, null, 512), [
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_LayoutSection, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        _push4(`<h1 class="mb-1 md:mb-3 text-lg md:text-2xl font-bold"${_scopeId3}>${ssrInterpolate((_a = unref(article)) == null ? void 0 : _a.title)}</h1>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_ArticleAuthor, {
                          "author-name": (_a = unref(article)) == null ? void 0 : _a.authorName,
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_ArticleLoopColumn, {
                          tag: "h3",
                          list: (_a = unref(moreNews)) != null ? _a : []
                        }, null, _parent4, _scopeId3));
                        _push4(`</div>`);
                      } else {
                        return [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_ArticleComment, {
                          "comment-list": (_a2 = (_a = unref(comments)) == null ? void 0 : _a.list) != null ? _a2 : [],
                          "article-id": (_b2 = (_b = unref(article)) == null ? void 0 : _b.id) != null ? _b2 : 0,
                        ...
                        return [
                          ...
                          createVNode(_component_ArticleComment, {
                            "comment-list": (_c2 = (_c = unref(comments)) == null ? void 0 : _c.list) != null ? _c2 : [],
                            "article-id": (_d2 = (_d = unref(article)) == null ? void 0 : _d.id) != null ? _d2 : 0,
                            onSubmit: createComment
                  ...
                  return [
                    createVNode(_component_LayoutSection, null, {
                      default: withCtx(() => {
                        var _a, _b, _c, _d, _e, _f;
                        return [
                          createVNode("h1", { class: "mb-1 md:mb-3 text-lg md:text-2xl font-bold" }, toDisplayString((_a = unref(article)) == null ? void 0 : _a.title), 1),
                          createVNode(_component_ArticleMeta, {
                            author: (_b = unref(article)) == null ? void 0 : _b.authorName,
                            "publish-time": (_c = unref(article)) == null ? void 0 : _c.publishTime,
                            class: "mb-3 md:mb-5"
                          ...
                          createVNode("div", { class: "pb-6" }, [
                            ((_d = unref(article)) == null ? void 0 : _d.type) === 11 ? (openBlock(), createBlock(_component_ArticleContentSingle, {
                              key: 0,
                              content: unref(article).content || "\u7121\u5167\u5BB9"
                            }, null, 8, ["content"])) : ((_e = unref(article)) == null ? void 0 : _e.type) === 12 ? (openBlock(), createBlock(_component_ArticleContentVideo, {
                              key: 1,
                              content: (_f = unref(article)) == null ? void 0 : _f.content
                            }, null, 8, ["content"])) : createCommentVNode("", true)
                          ])
...
//# sourceMappingURL=_articleSlug_-1af45d4c.mjs.map
