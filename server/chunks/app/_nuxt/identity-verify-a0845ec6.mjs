import { e as useState, f as useRouter, o as idCardRegex, b as __nuxt_component_1, i as _sfc_main$k, k as __nuxt_component_2$3, _ as _export_sfc, g as useHttpFetchPost, h as useBaseStore } from '../server.mjs';
import { useSSRContext, defineComponent, reactive, withCtx, unref, createVNode, ref, computed, mergeProps } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderAttr, ssrInterpolate, ssrRenderSlot, ssrIncludeBooleanAttr, ssrRenderStyle } from 'vue/server-renderer';
import 'ofetch';
import 'hookable';
import 'unctx';
import 'vue-router';
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d10ebd38"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useState("message");
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))} data-v-ef1c43fb><h1 data-v-ef1c43fb> jQuery Image Upload <small data-v-ef1c43fb>with preview</small></h1><div class="avatar-upload" data-v-ef1c43fb><div class="avatar-edit" data-v-ef1c43fb><input type="file" id="imageUpload" accept=".png, .jpg, .jpeg" data-v-ef1c43fb><label for="imageUpload" data-v-ef1c43fb></label></div><div class="avatar-preview" data-v-ef1c43fb><div id="imagePreview" style="${ssrRenderStyle({ "background-image": "url(http://i.pravatar.cc/500?img=7)" })}" data-v-ef1c43fb></div></div></div></div>`);
    };
  }
});
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Uploader.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ef1c43fb"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Uploader = __nuxt_component_4;
      ...
      _push(ssrRenderComponent(_component_UIForm, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_Uploader, null, null, _parent2, _scopeId));
          } else {
            return [
...
//# sourceMappingURL=identity-verify-a0845ec6.mjs.map
