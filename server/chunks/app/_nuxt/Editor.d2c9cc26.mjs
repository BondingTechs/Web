import { _ as _export_sfc, r as __nuxt_component_0$1 } from '../server.mjs';
import { useSSRContext, defineComponent, computed, reactive, ref, unref } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  dark:border-gray-50/[0.2] dark:focus:bg-gray-800`
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-6245291b>`);
      if (__props.label) {
        _push(`<div class="${ssrRenderClass([unref(labelSize), "fic mb-2"])}" data-v-6245291b><label${ssrRenderAttr("for", __props.id)} class="${ssrRenderClass([[{ "cursor-pointer": __props.id }], "block font-bold tracking-wide"])}" data-v-6245291b>${ssrInterpolate(__props.label)}</label>`);
        ssrRenderSlot(_ctx.$slots, "label", {}, null, _push, _parent);
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="relative model" data-v-6245291b>`);
      _push(ssrRenderComponent(_component_client_only, null, null, _parent));
      _push(`<div class="absolute transform -translate-y-1/2 right-2 top-1/2" data-v-6245291b>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6245291b"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=Editor.d2c9cc26.mjs.map
