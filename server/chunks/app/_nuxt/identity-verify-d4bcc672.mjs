import { e as useState, f as useRouter, b as __nuxt_component_1, i as _sfc_main$k, k as __nuxt_component_2$3, _ as _export_sfc, g as useHttpFetchPost, h as useBaseStore } from '../server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useState("message");
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))} data-v-e8e35f0f><h1 data-v-e8e35f0f> jQuery Image Upload <small data-v-e8e35f0f>with preview</small></h1><div class="avatar-upload" data-v-e8e35f0f><div class="avatar-edit" data-v-e8e35f0f><input type="file" id="imageUpload" accept=".png, .jpg, .jpeg" data-v-e8e35f0f><label for="imageUpload" data-v-e8e35f0f></label></div><div class="avatar-preview" data-v-e8e35f0f><div id="imagePreview" style="${ssrRenderStyle({ "background-image": "url(http://i.pravatar.cc/500?img=7)" })}" data-v-e8e35f0f></div></div></div></div>`);
    };
  }
});
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e8e35f0f"]]);
...
//# sourceMappingURL=identity-verify-d4bcc672.mjs.map
