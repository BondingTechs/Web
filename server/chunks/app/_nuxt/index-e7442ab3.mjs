import { _ as __nuxt_component_0, a as __nuxt_component_4$1, b as __nuxt_component_5$1 } from './index-e9d4f27b.mjs';
import { _ as _sfc_main$3 } from './Title-1189b41a.mjs';
...
import { _ as __nuxt_component_6 } from './Row-984f147b.mjs';
          ...
          ssrRenderList($props.list, (slide2) => {
            _push2(ssrRenderComponent(_component_SwiperSlide, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<div class="absolute top-0 left-0 w-full h-full" data-v-6e0ff698${_scopeId2}><img${ssrRenderAttr("src", slide2.thumbnail)} class="object-cover w-full h-full" data-v-6e0ff698${_scopeId2}></div><div class="row flex flex-wrap content-end absolute bottom-0 left-0 w-full px-4 h-1/3 pb-7 md:pb-5 lg:pb-10 lg:px-6" data-v-6e0ff698${_scopeId2}><div class="flex items-center w-full pb-1 md:pb-3 text-xs space-x-1 md:space-x-3 text-white" data-v-6e0ff698${_scopeId2}><div class="w-fit h-6 leading-6 px-2 rounded bg-green-500" data-v-6e0ff698${_scopeId2}>${ssrInterpolate($setup.ArticleType[slide2.type])}</div><!--[-->`);
                  ssrRenderList((_a = slide2.categories) == null ? void 0 : _a.split(","), (item, index2) => {
                    _push3(`<div class="w-fit h-6 leading-6 px-2 rounded bg-blue-500" data-v-6e0ff698${_scopeId2}>${ssrInterpolate(item)}</div>`);
                  });
                  _push3(`<!--]--></div><h3 class="title text-sm md:text-xl font-bold tracking-widest text-white" data-v-6e0ff698${_scopeId2}>${ssrInterpolate(slide2.title)}</h3></div>`);
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-6e0ff698"]]);
const _sfc_main$1 = {
  __name: "Hot",
...
//# sourceMappingURL=index-e7442ab3.mjs.map
