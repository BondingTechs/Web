...
import { _ as __nuxt_component_0$1 } from './Editor-f85cbd3c.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((_a = props.authorIntro) == null ? void 0 : _a.replaceAll(unref(htmlTag), "")) {
        _push(`<div class="flex-1 py-3 space-y-3 text-sm text-gray-800 lg:pr-4 dark:text-gray-300">${(_a2 = props.authorIntro) != null ? _a2 : ""}</div>`);
      } else {
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      const _component_UnoIcon = __nuxt_component_1$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex py-3 mb-1 border-b last:border-b-0 last:pb-0 last:mb-0 last-border-0 border-gray-200 dark:border-gray-700" }, _attrs))}><div class="rounded-full mr-4 overflow-hidden w-10 h-10"><img${ssrRenderAttr("src", _imports_0$1)} class="object-cover w-full h-full"></div><div class="flex-1"><p class="text-sm">${ssrInterpolate(__props.comment.author)}</p><p class="text-xs opacity-80 pb-2">${ssrInterpolate(__props.comment.createTime)}</p><div class="pb-2">${(_a = __props.comment.content) != null ? _a : ""}</div><div class="flex items-center space-x-4"><div class="cursor-pointer flex items-center space-x-1">`);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "py-3 mb-1 border-b border-gray-200 dark:border-gray-700 last:border-b-0 last:pb-0 last:mb-0" }, _attrs))}><div class="flex w-full"><div class="rounded-full mr-4 overflow-hidden w-12 h-12"><img${ssrRenderAttr("src", _imports_0$1)} class="object-cover w-full h-full"></div><div class="flex-1"><p class="text-sm">${ssrInterpolate(__props.comment.author)}</p><p class="text-xs opacity-80 pb-2">${ssrInterpolate(__props.comment.createTime)}</p><div class="pb-2">${(_a = __props.comment.content) != null ? _a : ""}</div><div class="flex items-center space-x-4"><div class="cursor-pointer flex items-center">`);
      if (!__props.comment.isLike) {
        _push(ssrRenderComponent(_component_UnoIcon, { class: "i-ic-outline-thumb-up w-4" }, null, _parent));
      } else {
        _push(`<!---->`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/news/[categorySlug]/[articleSlug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_articleSlug_-a513dca5.mjs.map
