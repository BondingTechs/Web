...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="grid md:grid-cols-2 gap-5 2xl:grid-cols-4 xl:grid-cols-3" data-v-7b068057><!--[-->`);
      ssrRenderList(__props.list, (article) => {
        _push(ssrRenderComponent(_component_nuxt_link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a, _b, _c, _d;
            if (_push2) {
              _push2(`<div class="relative h-0 mb-2 overflow-hidden rounded thumbnail" data-v-7b068057${_scopeId}><img${ssrRenderAttr("src", article.thumbnail)} class="absolute top-0 left-0 object-cover w-full h-full" data-v-7b068057${_scopeId}></div><div class="px-2" data-v-7b068057${_scopeId}>`);
              ...
              _push2(`<div class="flex flex-wrap justify-between w-full py-2 mt-auto text-xs text-gray-600 dark:text-gray-400" data-v-7b068057${_scopeId}><div class="flex justify-between w-full mb-1" itemprop="author" data-v-7b068057${_scopeId}><p data-v-7b068057${_scopeId}>${ssrInterpolate(article.author)}</p><p data-v-7b068057${_scopeId}>${ssrInterpolate(article.categories)}</p></div><div class="flex w-full" data-v-7b068057${_scopeId}><div class="mr-2 tracking-wider" itemprop="create-date" data-v-7b068057${_scopeId}>${ssrInterpolate((_b = (_a = article.publishTime) == null ? void 0 : _a.split(" ")) == null ? void 0 : _b.shift())}</div><div class="flex ml-auto items-center space-x-4" data-v-7b068057${_scopeId}><div class="flex items-center justify-end ml-auto space-x-1" data-v-7b068057${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UnoIcon, { class: "i-ic-baseline-thumb-up text-green-400" }, null, _parent2, _scopeId));
              _push2(`<span data-v-7b068057${_scopeId}>${ssrInterpolate(article.likes)}</span></div><div class="flex items-center ml-auto space-x-1" data-v-7b068057${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UnoIcon, { class: "i-ion-eye-sharp text-green-400" }, null, _parent2, _scopeId));
              _push2(`<span data-v-7b068057${_scopeId}>${ssrInterpolate(article.views)}</span></div></div></div></div></div>`);
            } else {
              return [
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7b068057"]]);

export { __nuxt_component_6 as _ };
//# sourceMappingURL=Row-54aece4a.mjs.map
