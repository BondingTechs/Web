...
const styles = {
  "../node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.a6defc12.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.4ba57b40.mjs').then(interopDefault),
  ...
  "pages/my.vue": () => import('./_nuxt/my-styles.9c173005.mjs').then(interopDefault),
  "pages/news/[categorySlug]/[articleSlug].vue": () => import('./_nuxt/_articleSlug_-styles.1e470948.mjs').then(interopDefault),
