...
import { f as fe, o as oe } from './transition.8c64f702.mjs';
                ...
                default: withCtx((_2, _push4, _parent3, _scopeId2) => {
                  if (_push4) {
                    ...
                    if (!dialogLoading.value) {
                      ...
                      _push4(`<div class="text-sm opacity-60 pb-2"${_scopeId2}>${ssrInterpolate(dialogInfo.value.publishDate)}</div><img${ssrRenderAttr("src", dialogInfo.value.thumbnail)}${_scopeId2}>`);
                      if (dialogInfo.value.content) {
                        _push4(`<div class="py-2"${_scopeId2}>${dialogInfo.value.content}</div>`);
                      } else {
                        _push4(`<!---->`);
                      }
                      _push4(`</div>`);
                    ...
                    return [
                      createVNode("div", { class: "fixed top-0 left-0 w-full h-full z-20" }, [
                        ...
                        !dialogLoading.value ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "text-sm opacity-60 pb-2" }, toDisplayString(dialogInfo.value.publishDate), 1),
                          createVNode("img", {
                            src: dialogInfo.value.thumbnail
                          }, null, 8, ["src"]),
...
//# sourceMappingURL=Row.16a81897.mjs.map
