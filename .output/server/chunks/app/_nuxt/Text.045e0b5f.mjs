...
const _sfc_main = {
  ...
  dark:border-gray-50/[0.2] dark:focus:bg-gray-800`
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="relative model flex"><input${ssrRenderAttr("id", __props.id)} type="text" class="${ssrRenderClass([{ "text-center": __props.center }, unref(defaultStyle), unref(inputSize)])}"${ssrRenderAttr("placeholder", __props.placeholder)}${ssrRenderAttr("value", __props.modelValue || __props.value)}${ssrIncludeBooleanAttr(__props.disabled) ? " disabled" : ""}${ssrIncludeBooleanAttr(__props.required) ? " required" : ""}><div class="absolute transform -translate-y-1/2 right-2 top-1/2">`);
...
//# sourceMappingURL=Text.045e0b5f.mjs.map
